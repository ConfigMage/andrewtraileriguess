...
- In Print setup, enter your machine's usable length, width, height, and extrusion width. The app compares the unrotated shell with that box and checks whether wall, roof, and floor thickness reach one entered extrusion width. Toggle the reference box in the 3D scene or clear the setup. Machine values stay in this browser and are not included in design JSON.
