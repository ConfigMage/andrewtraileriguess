...
function RightPanel({ tabletOpen }: { tabletOpen:boolean }) {
  ...
  return <aside className={`right-panel panel ${tabletOpen?'tablet-open':''}`}><div className="panel-heading"><small>02 / COMPONENTS</small><h2>Openings &amp; print plan</h2><p>Plan build-volume sections or choose an opening to edit.</p></div><div className="panel-scroll">
