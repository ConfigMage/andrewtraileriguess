...
function RightPanel({ tabletOpen }: { tabletOpen:boolean }) {
  ...
  return <aside className={`right-panel panel ${tabletOpen?'tablet-open':''}`}><div className="panel-heading"><small>02 / COMPONENTS</small><h2>Components &amp; print</h2><p>Check machine fit or choose an opening to edit.</p></div><div className="panel-scroll">
